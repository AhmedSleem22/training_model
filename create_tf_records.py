...
base_dir:
-Forder1: class_name1
			Contains: image_name1.png, image_name2.png
...
-Forder2: class_name2
			Contains: image_name1.png, image_name2.png
...
...
In order to run the code, you have to write something similar to the following example in the OS Terminal:
...
def main(args):
    ...
    supported_formats = ['*.png', '*.jpg', '*.JPG', '*.jpeg', '*.JPEG']
    filenames = []
